...
//   const [openChute, setOpenChute] = useState(false);
...
//         >
//           <Image
//             src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1745319822/Logo_img_rxgrwt.png" //  Corrected URL
...
//                   {/* Belt Type with nested dropdown */}
...
//                   {/* Chute Type with nested dropdown */}
...
//                         className="block text-sm hover:text-blue-600"
//                       >
//                         Colour sorter For Cashew
//                       </Link>
//                       <Link
//                         href="/Chute_Type3"
//                         className="block text-sm hover:text-blue-600"
//                       >
//                         Colour sorter for Millets & Fired gram
//                       </Link>
//                     </div>
//                   </div>
//                 </div>
...
//                 MultiGrains Sorting{" "}
//               </Link>
//               <Link href="/Spices" className="hover:text-blue-500 transition">
//                 Spices Sorting
//               </Link>
//               <Link href="/Pulses" className="hover:text-blue-500 transition">
//                 All Types Of Pulses Sorting
//               </Link>
//               <Link href="/Seeds" className="hover:text-blue-500 transition">
//                 Seeds Sorting
//               </Link>
//             </motion.div>
//           </div>
...
//               Gallery
//             </span>
//             <div className="absolute invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 bg-white text-black py-3 px-4 rounded-lg shadow-xl top-full left-0 min-w-[200px] z-50 space-y-2">
//               <Link
//                 href="/Gallery"
...
//             Our Team
//           </Link>
//           <Link href="/R&D" className="hover:text-gray-300 transition">
//             R&D
//           </Link>
//           <Link href="/Productss" className="hover:text-gray-300 transition">
//             Products
//           </Link>
//           <Link href="/Plans" className="hover:text-gray-300 transition">
//             Plans
//           </Link>
//           <div className="mx-2">
...
//             {galleryDropdownOpen && (
//               <div className="absolute bg-white shadow-md rounded-md mt-2 z-50 w-48 text-sm">
//                 <Link
//                   href="/Gallery"
    ...
    <nav className="w-[90%] max-w-7xl mx-auto my-4">
      <div className="flex justify-between items-center py-2 text-white rounded-xl bg-gradient-to-r from-[#1f3d3b] to-[#2b4a48] shadow-xl px-4">
        ...
        >
          ...
          {/* Gallery Dropdown */}
          <div className="relative group">
            <span className="hover:text-gray-300 cursor-pointer transition">Gallery</span>
            <div className="absolute invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 bg-white text-black py-3 px-4 rounded-lg shadow-xl top-full left-0 min-w-[200px] z-50 space-y-2">
              <Link href="/Gallery" className="block hover:text-blue-500 transition">Our Events</Link>
              <Link href="/Team" className="block hover:text-blue-500 transition">Our Team</Link>
              <Link href="/Gallery" className="block hover:text-blue-500 transition">Our Office</Link>
              <Link href="/Gallery" className="block hover:text-blue-500 transition">Manufacturing</Link>
              <Link href="/Gallery" className="block hover:text-blue-500 transition">Production</Link>
            </div>
          </div>
      ...
      {menuOpen && (
        ...
        >
          ...
          <div className="relative">
            <button onClick={() => setGalleryDropdownOpen(!galleryDropdownOpen)} className="flex items-center gap-1 hover:text-blue-600">
              Gallery <ChevronDown size={16} />
            </button>
            {galleryDropdownOpen && (
              <div className="absolute bg-white shadow-md rounded-md mt-2 z-50 w-48 text-sm">
                <Link href="/Gallery" className="block px-4 py-2 hover:bg-gray-100 text-gray-700" onClick={() => { setGalleryDropdownOpen(false); setMenuOpen(false); }}>Our Events</Link>
                <Link href="/Team" className="block px-4 py-2 hover:bg-gray-100 text-gray-700" onClick={() => { setGalleryDropdownOpen(false); setMenuOpen(false); }}>Our Team</Link>
                <Link href="/Gallery" className="block px-4 py-2 hover:bg-gray-100 text-gray-700" onClick={() => { setGalleryDropdownOpen(false); setMenuOpen(false); }}>Our Office</Link>
                <Link href="/Gallery" className="block px-4 py-2 hover:bg-gray-100 text-gray-700" onClick={() => { setGalleryDropdownOpen(false); setMenuOpen(false); }}>Manufacturing</Link>
                <Link href="/Gallery" className="block px-4 py-2 hover:bg-gray-100 text-gray-700" onClick={() => { setGalleryDropdownOpen(false); setMenuOpen(false); }}>Production</Link>
              </div>
            )}
          </div>
