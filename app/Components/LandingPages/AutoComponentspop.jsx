...
const AutoPopupChat = () => {
  ...
  const data = [
    ...
    {
      image: "https://res.cloudinary.com/dt2juqy9s/image/upload/v1745826592/support_zmszj6.avif",
      title: "Service Team",
      message: "Sujatha.A-9844015015",
    },
    {
  ...
  useEffect(() => {
    const t = setTimeout(() => {
      setShow(true);
    }, 40000); // Show the popup after 20 seconds
    return () => clearTimeout(t);
  }, []);
  ...
  return (
    <div
      className={`fixed top-22 right-10 z-[9999] transition-all duration-500 ${
        show ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-6 pointer-events-none"
      }`}
    >
      <div className="bg-white border rounded-xl w-[150px] sm:w-[180px] text-gray-800 shadow-md relative">
